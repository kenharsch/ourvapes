...
$(document).on('ready page:load', function() {
	// set the type filter click listeners for radio buttons
	// $('.type-filter').change(setType(this));

	// set the type filter click listeners for labels
	$('.type-filter').click(setTypeFunction(this));
});

function setTypeFunction(filter_el) {
	var filter_el_var = filter_el
	return function() {
		window.location = "?type="+$(filter_el_var).attr("type");
	};
}
;
(function() {
...
(function() {
  $(function() {
    ...
    return comments.on('ajax:success', '.edit_comment', function(request, response, status) {
      var form, holder;
      form = $(this);
