...
tank = Tank.create(name: "Davide", description: "1. High Polish.
...
tank = Tank.create(name: "Mini Davide", description: "New Anyvape Glassomizer Mini Davide
...
tank = Tank.create(name: "Aspire CE5-S BDC", description: "Aspire CE5-S BDC
...
tank = Tank.create(name: "iClear 30 Dual Coil", description: "Innokin iClear 30 dual coil clearomizer:
...
tank = Tank.create(name: "iClear X.I Pyrex BDC", description: "Innokin iClear X.I Pyrex BDC
...
tank = Tank.create(name: "Magoo C", description: "This is for pro vapers only who have experience with rebuildable atomizers!
...
button = Button.create(name: "itaste VTR", description: "iTaste VTR is solid variable wattage and voltage vaping device with detailed finish. It features a rotational wheel and a protective skeleton to hold the tank inside. The voltage and wattage can be adjusted with the rotational wheel; the screen displays voltage or wattage and offers intuitive control over settings leading to more accurate performance. *** Please note that the VTR does not come with a battery but can use any unprotected 18650
